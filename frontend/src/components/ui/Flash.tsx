...
const MESSAGES: Record<string, { tone: "success" | "danger" | "info"; text: string }> = {
  ...
  "post-updated": { tone: "success", text: "Post saved." },
  ...
  "user-blocked": { tone: "info", text: "Account blocked. They can no longer sign in." },
  "user-unblocked": { tone: "success", text: "Account unblocked." },
  "user-deleted": { tone: "info", text: "Account deleted." },
