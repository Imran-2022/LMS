...
export function Brand({
  ...
  return (
    <Link
      href={href}
      className={cx(
        "group inline-flex items-center gap-2.5 transition-[gap] duration-500 ease-in-out",
        collapsed && "gap-0",
        className,
      )}
    ...
    >
      ...
      {compact ? null : (
        <span
          className={cx(
            "overflow-hidden whitespace-nowrap text-[17px] font-bold tracking-tight text-ink-900 transition-[max-width,opacity,transform] duration-500 ease-in-out",
            collapsed
