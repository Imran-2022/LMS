        ...
        {posts.map((post) => (
          ...
          >
            ...
            <div className="flex shrink-0 items-center gap-1">
              ...
              <Link href={`/manage/blog/${post.id}`} aria-label={`Edit ${post.title}`} title="Edit post" className="grid h-9 w-9 place-items-center rounded text-ink-500 hover:bg-brand-50 hover:text-brand-700">
